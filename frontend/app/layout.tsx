...
export default async function RootLayout({ children }: { children: ReactNode }) {
  ...
  const userEmail = session?.user?.email || "student@bennett.edu.in";
          ...
          <header className="sticky top-0 z-50 border-b border-white/10 backdrop-blur-2xl bg-gradient-to-b from-black/60 to-black/20 shadow-2xl">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 py-4">
              <div className="flex items-center justify-between gap-4">
                ...
                <HeaderNavigation userName={userName} userEmail={userEmail} initial={initial} />
              </div>
            </div>
          </header>
          ...
          <footer className="border-t border-white/10 mt-auto backdrop-blur-xl bg-gradient-to-t from-black/60 to-black/20">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 py-8 sm:py-12">
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                ...
                <div className="animate-slide-in-up" style={{ animationDelay: '0.1s' }}>
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <Link href="/campus-map" className="text-gray-400 hover:text-indigo-400 transition-colors block">Campus Map</Link>
                ...
                <div className="animate-slide-in-up" style={{ animationDelay: '0.2s' }}>
                  ...
                  <div className="space-y-2 text-sm text-gray-400">
                    <p className="flex items-center gap-2"><span className="w-2 h-2 rounded-full bg-indigo-400"></span> Security: +91-120-4754007</p>
                    <p className="flex items-center gap-2"><span className="w-2 h-2 rounded-full bg-red-400"></span> Medical: +91-120-4754006</p>
                    <p className="flex items-center gap-2"><span className="w-2 h-2 rounded-full bg-blue-400"></span> Admin: +91-120-4754000</p>
                  </div>
                </div>
              ...
              <div className="mt-8 pt-6 border-t border-white/5 text-center text-gray-500 text-xs sm:text-sm">
                ...
                <p className="mt-2 text-gray-600">Built for the BenAI community</p>
              </div>
            </div>
          </footer>
        </div>
